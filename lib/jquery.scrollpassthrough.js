(function (root, factory) {
    ...
    function ScrollPassThrough(element, scrollElement, options) {
        ...
        this._element.on('destroy.scrollpassthrough', this.destroy.bind(this));

        // Init!
        this.enable();
    }

    ScrollPassThrough.prototype.enable = function () {
        if (this._enabled) {
            return this;
        }
    ...
    ScrollPassThrough.prototype.disable = function () {
        if (!this._enabled) {
            return this;
        }
    ...
    ScrollPassThrough.prototype.destroy = function () {
        this.disable();

        this._element.off('destroy.scrollpassthrough');

        this._element.removeData('_scrollpassthrough');
        this._element = this._scrollElement = this._nativeScrollElement;
    };

    // ------------------------------------

    ScrollPassThrough.prototype._onWheelMouseEvent = function (e) {
        var myEvt = new e.constructor(e.type, e);

        this._nativeScrollElement.dispatchEvent(myEvt);
    };

    ScrollPassThrough.prototype._onWheelPointerEvents = function (e) {
        var that = this;
    ...
    ScrollPassThrough.prototype._onWheelScrollPointerEvents = function () {
        var that = this;
    ...
    $.fn.scrollpassthrough = function () {
        var args = Array.prototype.slice.call(arguments);

        return this.each(function () {
            var $this = $(this),
                data  = $this.data('_scrollpassthrough');

            if (typeof args[0] === 'string' && ScrollPassThrough.prototype[args[0]]) {
                if (!data) {
                    throw new Error('Plugin was not yet initialized');
                }
                ...
                $this.data('_scrollpassthrough', (data = new ScrollPassThrough(this, args[0], args[1])));
            }
        });
    };

    $.fn.scrollpassthrough.Constructor = ScrollPassThrough;
